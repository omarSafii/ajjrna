...
export const CarouselContent = React.forwardRef<HTMLDivElement, { containerClassName?: string } & React.HTMLAttributes<HTMLDivElement>>(
  ({ className, containerClassName, ...props }, ref) => {
    const { carouselRef, orientation } = useCarousel();

    return (
      <div ref={carouselRef} className={cn("overflow-hidden py-4", containerClassName)}>
