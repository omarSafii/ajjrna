...
import { ToggleVariants, toggleVariants } from "@/components/ui/Toggle";
...
>(({ className, variant, size, children, ...props }, ref) => (
  <ToggleGroupPrimitive.Root ref={ref} className={cn("flex flex-wrap items-center justify-center gap-1", className)} {...props}>
